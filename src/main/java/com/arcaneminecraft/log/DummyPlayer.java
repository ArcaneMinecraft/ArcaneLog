...
/**
 * CoreProtect xClass for making player commands and chat loggable
 */
public final class DummyPlayer implements Player {
    static JavaPlugin plugin;
    private final String name, displayName;
    private final UUID uuid;
    private final Location location = new Location(getWorld(), 0.0, 0.0, 0.0);

    DummyPlayer(String name, String displayName, String uuid) {
        this.name = name;
